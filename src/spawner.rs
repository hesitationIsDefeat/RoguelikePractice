...
use crate::{Name, Player, Position, Renderable, State, Item, RequiresItem, PermanentItem, SerializeMe, Place, BelongsTo, Portal, ContainsItem, Npc, HasDialogue};
...
pub fn build_npc(gs: &mut State, name: String, domain: Place, coord: (i32, i32), dialogues: Vec<&str>, requires_item: Option<Entity>, contains_item: Option<Entity>) -> Entity {
    let mut builder = gs.ecs
        .create_entity()
        .with(Name { name })
        .with(Npc {})
