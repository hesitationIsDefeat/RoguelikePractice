...
pub const CREDIT_3_STR: &str = "Kaynaklar: Osmanli 9. Cilt / Osmanli 10. Cilt / Osmanlı 11. Cilt";
...
pub const PLACE_OTTOMAN_LEFT_NAME: &str = "Osmanli Bati Taraf";
pub const PLACE_OTTOMAN_RIGHT_NAME: &str = "Osmanli Dogu Taraf";
pub const PLACE_OTTOMAN_TOP_NAME: &str = "Osmanli Kuzey Taraf";
...
pub const OTTOMAN_KEY_1_NAME: &str = "Osmanli Bati Anahtari";
...
pub const OTTOMAN_KEY_2_NAME: &str = "Osmanli Kuzey Anahtari";
...
pub const OTTOMAN_KEY_3_NAME: &str = "Osmanli Dogu Anahtari";
